...
exports.config = {
  ...
  */
  ...
  // -----------------------------------------------------------------
  capabilities: {
    'browserstack.user' : process.env.BROWSER_USERNAME,
    'browserstack.key' : process.env.BROWSER_ACCESS_KEY,
    // Needed for testing localhost
    //'browserstack.local' : 'true',
    browserName: 'chrome',
    chromeOptions: { binary: '/Users/pressenter/usr/local/Caskroom/google-chrome/latest/Google Chrome.app/Contents/MacOS/Google Chrome' },
  },
  ...
  */
  ...
  baseUrl: 'http://salty-coast-93499.herokuapp.com',
